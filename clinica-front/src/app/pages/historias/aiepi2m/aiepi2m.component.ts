...
@Component({
  	selector: 'app-aiepi2m',
  	templateUrl: './aiepi2m.component.html',
  	styleUrls: ['./aiepi2m.component.css']
})
export class Aiepi2mComponent implements OnInit {
    ...
    Page1(datos, page = null) {
    	let motivo = datos[159]['VALOR'] != null ? datos[159]['VALOR'] : "NO REFIERE";
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 70px;">'+motivo+'</div>' +
                '</div>' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 60px;">'+(datos[160]['VALOR'] != null ? datos[160]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
    ...
    Page2(datos, page = null) {
    	var imc = (datos[50]['VALOR'] != 0 && datos[51]['VALOR'] != 0) ? datos[50]['VALOR']/datos[51]['VALOR'] : 0;
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">PESO AL NACER:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">EL NIÑO PRESENTA APNEA:</div>' +
    ...
    Page3(datos, page = null) {
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">VERIFICAR SI TIENE UNA ENFERMEDAD MUY GRAVE O INFECCIÓN LOCAL:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">DIAGNOSTICO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[101]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">PUEDE BEBER O TOMAR EL PECHO?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[102]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">VOMITA TODO?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[103]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HA TENIDO FIEBRE?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[104]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HA TENIDO HIPOTERMIA?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[105]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HA TENIDO CONVULSIONES?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[106]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HA DEJADO DE RESPIRAR?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[107]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">SANGRE EN HECES:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[108]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">MALFORMACIONES CONGÉNITAS?:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[109]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">LETARGICO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[110]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">SE VE MAL:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[111]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">ALETEO(NASAL):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[112]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">QUEJIDO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[113]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">4 DIURESIS EN 24 HORAS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[114]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">PALIDEZ(INTENSA):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[115]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">ICTERICIA POR DEBADO DEL OMBLIGO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[116]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">PETEQUIAS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[117]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">EQUIMOSSIS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[118]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HEMORRAGIA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[119]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">FONTANELA(ABOMBADA):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[120]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">SECRECION CONJUNTIVAL PURULENTA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[121]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">OMBLIGO ERITEMATOSO O CON SECERECION:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[122]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">PUSTULAS O MUCHAS O EXTENSAS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[123]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">PLACAS BLANQUECINAS EN BOCA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[124]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">SE MUEVE MENOS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[125]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">TIRAJE(SUBCOSTAL):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[126]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">ESTRIDOR:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[127]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">2DO RECUENTO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[128]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">TAQUICARDIA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[120]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">FLACIDO:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[130]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">CIANOSIS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[131]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">SIBILANCIA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[132]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">RESPIRACION(RAPIDA):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[133]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">LLENADO CAPILAR >2 SEGUNDOS:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[134]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">HEMORRAGIA:</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[135]['VALOR']+'</div>' +
                '<div class="col-md-4" style="text-transform: uppercase !important;">DISTENCION(ABDOMINAL):</div>' +
                '<div class="col-md-2" style="text-transform: uppercase !important;">'+datos[136]['VALOR']+'</div>' +
                '</div>'+
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+datos[137]['VALOR']+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">VERIFICAR SI EXISTE UN PROBLEMA DE ALIMENTACIÓN:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">TIENE ALGUNA DIFICULTAD PARA ALIMENTARSE:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">HA DEJADO DE COMER:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[140]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">SE ALIMENTA AL PECHO:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[141]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">LE OFRECE EN FORMA EXCLUSIVA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[142]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">RECIBE OTRA LECHE:</div>' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">TOCA EL SENO CON EL MENTÓN:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[144]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">BOCA BIEN ABIERTA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[145]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">LABIO INFERIOR VOLTEADO HACIA AFUERA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[146]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">AREOLA MÁS VISIBLE POR ENCIMA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[147]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">EVALUAR SUCCION:</div>' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+datos[149]['VALOR']+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+datos[150]['VALOR']+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+datos[151]['VALOR']+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+datos[152]['VALOR']+'</div>' +
                '</div>';
        return html;
    }
    ...
    Page4(datos, da) {
        ...
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">EVALUAR OTROS PROBLEMAS Y COMPLETAR EL EXAMEN FÍSICO:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">EVALUAR OTROS PROBLEMAS Y COMPLEMENTAR EXAMEN FISICO:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[153]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">ESCRIBIR RECOMENDACIONES Y ORIENTACIONES DADAS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[154]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">CUANDO VOLVER A CONSULTA DE CONTROL:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[155]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">REFERIDO A CONSULTA DE:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[156]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">MEDIDAS PREVENTIVAS ESPECIFICAS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[157]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">RECOMENDACIONES DE BUEN TRATO:</div>' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+da.DIAGNOSTICOEV+'</div>' +
                '</div>';
        return html;
    }
    ...
    Header(empresa, paciente, id) {
        ...
        var html = '<div class="col-md-3 text-left" style="margin: 0;padding: 0;font-size: 12px;">Fecha Impresión: '+fechai+'</div>' +
                ...
                '<div class="col-md-12 text-center"><h3>HISTORIA CLINICA AIEPI LACTANTE MENOR DE DOS MESES</h3></div>';
        return html;
    }
    ...
    CrearImagen(pdf, div, terminar) {
        ...
        html2canvas(div).then(canvas => {
            ...
            if(terminar == true) {
                ...
                that.tipo_id.emit(0);
                /*pdf.autoPrint();
                pdf.save('AIEPININOMENOR2MESES.pdf');*/
