...
export class ReferenciaComponent implements OnInit {
    ...
    Guardar() {
        ...
        this.referenciaForm.get('ID_HISTORIA').setValue($('#HISTORIA').val());
    	this.referenciaForm.get('DATOSHISTORIA').setValue(datos);
    	this.referenciaForm.get('DATOSPACIENTE').setValue(pac);
        this.referenciaForm.get('DATOS').setValue(datos1);
        this.referenciaForm.get('PACIENTE').setValue($('#PACIENTE').val());
        this.referenciaForm.get('PRESTADOR').setValue(this.role == 'ADMINISTRADOR' ? $('#ID_USUARIO').val() : this.id_user);
        this.referenciaForm.get('ID_CITA').setValue(this.id_cita);
        if(this.historia_id == 0) {
	        ...
	        this.historiasService.saveHistoriaPaciente(this.referenciaForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
	    	...
	    	this.historiasService.updateHistoriaPaciente(this.historia_id, this.referenciaForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
    ...
    Page1(datos, da, page = null) {
        let imc = (datos[10]['VALOR'] != 0 && datos[11]['VALOR'] != 0) ? datos[10]['VALOR']/datos[11]['VALOR'] : 0;
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">INFORMACION GENERAL:</div>' +
                ...
                '<div class="col-md-3" style="text-transform: uppercase !important;">INSTITUCION:</div>' +
                '<div class="col-md-9" style="text-transform: uppercase !important;">'+datos[42]['VALOR']+'</div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">ESPECIALIDAD:</div>' +
                '<div class="col-md-9" style="text-transform: uppercase !important;">'+datos[43]['VALOR']+'</div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">DIAGNOSTICO PAL</div>' +
                '<div class="col-md-9" style="text-transform: uppercase !important;">'+da[datos[49]['CAMPO']]+'</div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">DIAGNOSTICO REL:</div>' +
                '<div class="col-md-9" style="text-transform: uppercase !important;">'+da[datos[50]['CAMPO']]+'</div>' +
                '</div>' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 60px;">'+(datos[47]['VALOR'] != null ? datos[47]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">CAUSA DE LA REMISION:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 60px;">'+(datos[48]['VALOR'] != null ? datos[48]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                ...
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">RESUMEN DE LA HISTORIA CLINICA:</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 40px;">'+(datos[44]['VALOR'] != null ? datos[44]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 60px;">'+(datos[45]['VALOR'] != null ? datos[45]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
    ...
    Header(empresa, paciente, id) {
        ...
        var html = '<div class="col-md-3 text-left" style="margin: 0;padding: 0;font-size: 12px;">Fecha Impresión: '+fechai+'</div>' +
                ...
                '<div class="col-md-12 text-center"><h3>HISTORIA CLINICA REFERENCIA Y CONTRAREFERENCIA</h3></div>';
        return html;
    }
    ...
    clearAll() {
        this.referenciaForm.get('DATOSHISTORIA').setValue('');
        this.referenciaForm.get('DATOSPACIENTE').setValue('');
        this.referenciaForm.get('DATOS').setValue('');
        this.referenciaForm.get('PACIENTE').setValue('');
        this.referenciaForm.get('PRESTADOR').setValue('');
        this.referenciaForm.get('ID_HISTORIA').setValue(0);
        this.referenciaForm.get('ID_CITA').setValue(0);
