...
export class AdultomayorComponent implements OnInit {
    ...
    id_cita: any = 0;
  	...
  	ngOnChanges(changes: SimpleChanges) {
        ...
        if(tipo)
            if((tipo.currentValue == 1 || tipo.currentValue == 35) && pr) {
	...
	ngAfterViewInit(): void {
  	...
  	initForm() {
        this.adultomForm = this.formBuilder.group({
            DATOSHISTORIA: [''],
            DATOSPACIENTE: [''],
            ID_HISTORIA: [''],
            DATOS: [''],
    ...
    Guardar() {
        ...
        this.adultomForm.get('ID_HISTORIA').setValue($('#HISTORIA').val());
    	this.adultomForm.get('DATOSHISTORIA').setValue(datos);
    	this.adultomForm.get('DATOSPACIENTE').setValue(pac);
        this.adultomForm.get('DATOS').setValue(datos1);
        this.adultomForm.get('PACIENTE').setValue($('#PACIENTE').val());
        this.adultomForm.get('PRESTADOR').setValue(this.role == 'ADMINISTRADOR' ? $('#ID_USUARIO').val() : this.id_user);
        this.adultomForm.get('ID_CITA').setValue(this.id_cita);
        if(this.historia_id == 0) {
	        ...
	        this.historiasService.saveHistoriaPaciente(this.adultomForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
	    	...
	    	this.historiasService.updateHistoriaPaciente(this.historia_id, this.adultomForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
    ...
    Page1(datos,page = null) {
        let motivo = datos[125]['VALOR'] != null ? datos[125]['VALOR'] : "NO REFIERE";
        let enfermedad = datos[126]['VALOR'] != null ? datos[126]['VALOR'] : "NO REFIERE";
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 80px;">'+motivo+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;height: 80px;">'+enfermedad+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">ENFISEMA:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">CONSUME CIGARRILLO:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[17]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">CONSUME ALCOHOL:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[18]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">FRECUENCIA CONSUMO ALCOHOL:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[19]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">DROGADICCION FRECUENCIA TIEMPO:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[20]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">EXPOSICION AL HUMO TIEMPO:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">ACTIVIDAD FISICA:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">MANEJO DEL ESTRÉS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[26]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">OTROS HABITOS ALIMENTARIOS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[27]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">RIESGO DE CAIDAS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[28]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">RIESGO PSICOSOCIAL:</div>' +
                ...
                '</div>' +
                '<div class="row" style="margin-bottom: 1rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">TAMIZAJE DE VIOLENCIA:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">HA SUFRIDO ALGUN TIPO DE VIOLENCIA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[36]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">USTED SE SIENTE EN RIESGO:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[37]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">USTED HA GOLPEADO(A) ALGUNA VEZ POR SU PAREJA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[38]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">USTED QUIERE HABLAR DEL TEMA Y RECIBIR ATENCION PSICOLOGICA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[39]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">FICHA SIVIGILA:</div>' +
    ...
    Page2(datos,page = null) {
        let imc = (datos[83]['VALOR'] != 0 && datos[82]['VALOR'] != 0) ? datos[82]['VALOR']/datos[83]['VALOR'] : 0;
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">ESFERA MENTAL:</div>' +
    ...
    Page3(datos, da) {
        ...
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-3"></div><div class="col-md-2 text-center">DERECHA</div><div class="col-md-2 text-center">IZQUIERDA</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">DOLOR:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[101]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[102]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">SECRECION PEZON:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[103]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[104]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">HINCHAZON MAMA:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[105]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[106]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">GANGLIOS:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[107]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[108]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">MASAS:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[109]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[110]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">RETRACCION:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[111]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[112]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">PIEL NARANJA:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[113]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[114]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">RED VENOSA DILATADA:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[115]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[116]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">RETRACCION PEZON:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[117]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[118]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">SECRECION PEZON:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[119]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[120]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">ADENOPATIAS AXILARES:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[121]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[122]['VALOR']+'</div><div class="col-md-5"></div>' +
                '<div class="col-md-3" style="text-transform: uppercase !important;">ADENOPATIAS CLAVICULA:</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[123]['VALOR']+'</div>' +
                '<div class="col-md-2 text-center" style="text-transform: uppercase !important;">'+datos[124]['VALOR']+'</div><div class="col-md-5"></div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">EXAMENES DE LABORATORIOS:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>';
                if(lab.length > 0) {
                    for(var i in lab) {
                        html += '<div class="col-md-6" style="text-transform: uppercase !important;">'+lab[i]['items']['NOM_ITEM']+':</div>' +
                        '<div class="col-md-6" style="text-transform: uppercase !important;">'+(lab[i]['RESULTADO'] != null ? lab[i]['RESULTADO'] : '')+'</div>';
                    }
                }
                else {
                ...
                html += '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">RIESGOS POTENCIALES:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[127]['VALOR'] != null ? datos[127]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[128]['VALOR'] != null ? datos[128]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">PLAN DE INTERVENCION:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[129]['VALOR'] != null ? datos[129]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 1rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;flex: 0 0 99%;padding-right: 15px;padding-left: 15px;font-size: 12px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[130]['VALOR'] != null ? datos[130]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>';
        return html;
    }
    ...
    Header(empresa, paciente, id) {
        ...
        var html = '<div class="col-md-3 text-left" style="margin: 0;padding: 0;font-size: 12px;">Fecha Impresión: '+fechai+'</div>' +
                ...
                '<div class="col-md-12 text-center"><h3>HISTORIA CLINICA ADULTO MAYOR</h3></div>';
        return html;
    }
    ...
    CrearImagen(pdf, div, terminar) {
        ...
        html2canvas(div).then(canvas => {                           
            ...
            if(terminar == true) {
                ...
                that.tipo_id.emit(0);
                /*pdf.autoPrint();
                pdf.save('HISTORIACLINICAPyPADULTO.pdf');*/
    ...
    clearAll() {
        this.adultomForm.get('DATOSHISTORIA').setValue('');
        this.adultomForm.get('DATOSPACIENTE').setValue('');
        this.adultomForm.get('DATOS').setValue('');
        this.adultomForm.get('PACIENTE').setValue('');
        this.adultomForm.get('PRESTADOR').setValue('');
        this.adultomForm.get('ID_HISTORIA').setValue(0);
        this.adultomForm.get('ID_CITA').setValue(0);
