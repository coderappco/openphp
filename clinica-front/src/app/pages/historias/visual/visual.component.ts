...
export class VisualComponent implements OnInit {
    ...
    id_cita: any = 0;
  	...
  	ngOnChanges(changes: SimpleChanges) {
        ...
        if(tipo)
            if((tipo.currentValue == 2 || tipo.currentValue == 42) && pr) {
    ...
    Guardar() {
        ...
        this.visualForm.get('ID_HISTORIA').setValue($('#HISTORIA').val());
    	this.visualForm.get('DATOSHISTORIA').setValue(datos);
    	this.visualForm.get('DATOSPACIENTE').setValue(pac);
        this.visualForm.get('DATOS').setValue(datos1);
        this.visualForm.get('PACIENTE').setValue($('#PACIENTE').val());
        this.visualForm.get('PRESTADOR').setValue(this.role == 'ADMINISTRADOR' ? $('#ID_USUARIO').val() : this.id_user);
        this.visualForm.get('ID_CITA').setValue(this.id_cita);
        if(this.historia_id == 0) {
	        ...
	        this.historiasService.saveHistoriaPaciente(this.visualForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
	    	...
	    	this.historiasService.updateHistoriaPaciente(this.historia_id, this.visualForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
    ...
    clearAll() {
        this.visualForm.get('DATOSHISTORIA').setValue('');
        this.visualForm.get('DATOSPACIENTE').setValue('');
        this.visualForm.get('DATOS').setValue('');
        this.visualForm.get('PACIENTE').setValue('');
        this.visualForm.get('PRESTADOR').setValue('');
        this.visualForm.get('ID_HISTORIA').setValue(0);
        this.visualForm.get('ID_CITA').setValue(0);
    ...
    GenerarPdf(id) {
        ...
        this.historiasService.getHistoriaPacientes(id)
            .subscribe(data => {
                ...
                var html = '';
                var header = '';
                html = this.Header(da.usuario.empresa.empresa, da.paciente, id);console.log(da.DIAGNOSTICOHIST);
    ...
    Page1(datos,page = null) {
    	let imc = (datos[19]['VALOR'] != 0 && datos[20]['VALOR'] != 0) ? datos[19]['VALOR']/datos[20]['VALOR'] : 0;
        var motivo = datos[46]['VALOR'] != null ? datos[46]['VALOR'] : "NO REFIERE";
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">CONVULSIONES:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">PARPADOS ORBITAS Y ANEXOS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[21]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">MOTILIDAD PARPEBRAL Y OCULAR:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[22]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">CONJUNTIVAS:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[23]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">CORNEAS:</div>' +
                ...
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                '<div class="col-md-12" style="background-color: #f3f3f3;font-weight: bolder;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;">VALORACION AGUDEZA VISUAL:</div>' +
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">OJO DERECHO VISTA LEJANA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[30]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">OJO DERECHO VISTA CERCANA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[31]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">OJO IZQUIERDO VISTA LEJANA:</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">'+datos[32]['VALOR']+'</div>' +
                '<div class="col-md-6" style="text-transform: uppercase !important;">OJO IZQUIERDO VISTA CERCANA:</div>' +
                ...
                '<div class="col-md-6" style="text-transform: uppercase !important;">CONDUCTA:</div>' +
    ...
    Page2(datos, da) {
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(da[datos[48]['CAMPO']] != '' ? da[datos[48]['CAMPO']] : "NO REFIERE")+'</div>' +
                '</div>';
        return html;
    }
    ...
    Header(empresa, paciente, id) {
        ...
        var html = '<div class="col-md-3 text-left" style="margin: 0;padding: 0;font-size: 12px;">Fecha Impresión: '+fechai+'</div>' +
                ...
                '<div class="col-md-12 text-center"><h3>HISTORIA CLINICA AGUDEZA VISUAL</h3></div>';
        return html;
    }
    ...
    CrearImagen(pdf, div, terminar) {
        ...
        html2canvas(div).then(canvas => {
            ...
            if(terminar == true) {
                ...
                that.tipo_id.emit(0);
                /*pdf.autoPrint();
                pdf.save('HISTORIACLINICAVISUAL.pdf');*/
