...
@Component({
  	selector: 'app-consulta1vez',
  	templateUrl: './consulta1vez.component.html',
  	styleUrls: ['./consulta1vez.component.css']
})
export class Consulta1vezComponent implements OnInit {

  	consulta1vezForm: FormGroup;
	escolaridad: any = [];
    etnia: any = [];
    ocupacion: any = [];
    discapacidad: any = [];
	...
	ngAfterViewInit(): void {
  	...
  	initForm() {
        this.consulta1vezForm = this.formBuilder.group({
            DATOSHISTORIA: [''],
            DATOSPACIENTE: [''],
            ID_HISTORIA: [''],
            DATOS: [''],
    ...
    Guardar() {
        ...
        this.consulta1vezForm.get('ID_HISTORIA').setValue($('#HISTORIA').val());
    	this.consulta1vezForm.get('DATOSHISTORIA').setValue(datos);
    	this.consulta1vezForm.get('DATOSPACIENTE').setValue(pac);
        this.consulta1vezForm.get('DATOS').setValue(datos1);
        this.consulta1vezForm.get('PACIENTE').setValue($('#PACIENTE').val());
        this.consulta1vezForm.get('PRESTADOR').setValue(this.role == 'ADMINISTRADOR' ? $('#ID_USUARIO').val() : this.id_user);
        this.consulta1vezForm.get('ID_CITA').setValue(this.id_cita);
        if(this.historia_id == 0) {
	        ...
	        this.historiasService.saveHistoriaPaciente(this.consulta1vezForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
	    	...
	    	this.historiasService.updateHistoriaPaciente(this.historia_id, this.consulta1vezForm.value)
	        	.subscribe(data => {
	        		let da: any = data;
	        		this.clearAll();
    ...
    Page1(datos, page = null) {
    	let motivo = datos[112]['VALOR'] != null ? datos[112]['VALOR'] : "NO REFIERE";
        let enfermedad = datos[113]['VALOR'] != null ? datos[113]['VALOR'] : "NO REFIERE";
    ...
    Page2(datos, page = null) {
    	var imc = (datos[62]['VALOR'] != 0 && datos[63]['VALOR'] != 0) ? datos[62]['VALOR']/datos[63]['VALOR'] : 0
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
    ...
    Page3(datos, da) {
        var html = '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[114]['VALOR'] != null ? datos[114]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(da[datos[117]['CAMPO']] != '' ? da[datos[117]['CAMPO']] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[115]['VALOR'] != null ? datos[115]['VALOR'] : "NO REFIERE")+'</div>' +
                '</div>' +
                '<div class="row" style="margin-bottom: 2rem !important;-webkit-box-flex: 0;-ms-flex: 0 0 99%;padding-right: 15px;padding-left: 15px;flex: 0 0 99%;font-size: 15px; box-sizing: content-box;overflow: visible; border: 0; border: 1px solid #e9ecef;">' +
                ...
                '<div class="col-md-12" style="height: 0;border: 0; border-top: 1px solid #aaaaaa;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;margin-left: -15px;box-sizing: content-box;overflow: visible;"></div>' +
                '<div class="col-md-12" style="text-transform: uppercase !important;">'+(datos[116]['VALOR'] != null ? datos[116]['VALOR'] : " NO REFIERE")+'</div>' +
                '</div>';
        return html;
    }
    ...
    Header(empresa, paciente, id) {
        ...
        var html = '<div class="col-md-3 text-left" style="margin: 0;padding: 0;font-size: 12px;">Fecha Impresión: '+fechai+'</div>' +
                ...
                '<div class="col-md-12 text-center"><h3>HISTORIA CLINICA CONSULTA EXTERNA 1ERA VEZ</h3></div>';
        return html;
    }
    ...
    clearAll() {
        this.consulta1vezForm.get('DATOSHISTORIA').setValue('');
        this.consulta1vezForm.get('DATOSPACIENTE').setValue('');
        this.consulta1vezForm.get('DATOS').setValue('');
        this.consulta1vezForm.get('PACIENTE').setValue('');
        this.consulta1vezForm.get('PRESTADOR').setValue('');
        this.consulta1vezForm.get('ID_HISTORIA').setValue(0);
        this.consulta1vezForm.get('ID_CITA').setValue(0);
