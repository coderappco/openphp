...
export class UserService {
    ...
    getPrestadores(empresa = null): Observable<any> {
        return this.http.get<any>(`${this.globals.apiUrl}/getprestadores?empresa=`+empresa);
    }

    getUserIdent(ident): Observable<any> {
        return this.http.get<any>(`${this.globals.apiUrl}/user?ident=`+ident);
    }
    ...
    removeFirma(id: number, firma) {
        return this.http.get(`${this.globals.apiUrl}/users/removfirmas?id=`+id+`&firma=`+firma);
    }
}